...
<head>
    ...
    <title>Upload File USSD - Claro Guatemala</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Upload USSD CLARO</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Upload Excel</h1>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <form action="UploadDownloadFileServlet" method="post" enctype="multipart/form-data" role="form">
